...
def addExtra(artist):
  ...
  body = {
    ...
    "past_shows": list(filter(lambda show: show.start_time < now, artist.artist_shows )),
    "upcoming_shows": [],
    "past_shows_count": len(list(filter(lambda show: show.start_time < now, artist.artist_shows ))),
    "upcoming_shows_count": 0,
  }
